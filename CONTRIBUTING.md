## Contributing to Qualcomm USB Userspace Drivers
...
2. [Fork](https://github.com/qualcomm/qcom-usb-userspace-drivers/fork) and clone the repository.
    ```bash
    git clone https://github.com/<username>/qcom-usb-userspace-drivers.git
    ```
...
4. Create an upstream `remote` to make it easier to keep your branches up-to-date:
    ```bash
    git remote add upstream https://github.com/qualcomm/qcom-usb-userspace-drivers.git
    ```
...
9. [Submit a pull request](https://github.com/qualcomm/qcom-usb-userspace-drivers/pulls) from your branch to `develop`.
